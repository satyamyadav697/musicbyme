...
HELP_7 = """
<u><b>📡 Active Calls Commands:</b></u>[for Sudo Users]

/activecalls or /acalls : to view the total number of ongoing voice and video chats across all served groups. 
"""
...
/broadcast [ᴍᴇssᴀɢᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ] : ᴜsᴇ ᴛʜᴇ sᴜʙ ᴛᴀɢs ɢɪᴠᴇɴ ʙᴇʟᴏᴡ. 

<u>ʙʀᴏᴀᴅᴄᴀsᴛɪɴɢ ᴍᴏᴅᴇs :</u>
<b>-forward</b> : ғᴏʀᴄᴇs ᴛʜᴇ ʙᴏᴛ ᴛᴏ ғᴏʀᴡᴀʀᴅ ᴛʜᴇ ʙʀᴏᴀᴅᴄᴀsᴛᴇᴅ ᴍᴇssᴀɢᴇ..
<b>-users</b> : ʙʀᴏᴀᴅᴄᴀsᴛs ᴛʜᴇ ᴍᴇssᴀɢᴇ ᴛᴏ ᴛʜᴇ ᴜsᴇʀs ᴡʜᴏ ʜᴀᴠᴇ sᴛᴀʀᴛᴇᴅ ʏᴏᴜʀ ʙᴏᴛ.

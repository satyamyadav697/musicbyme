    ...
    async def wrapper(client, message):
        try:
            ...
            if message.command[0][0] == "v" or "-v" in message.text:
                video = True
            elif len(message.command[0]) > 1 and message.command[0][1] == "v":
                video = True
            ...
            if not await is_active_chat(chat_id):
                ...
                try:
                    try:
                        ...
                        return await message.reply_text("❌ I need to be admin to verify assistant presence.")
            ...
            return await wrapper(client, message)
